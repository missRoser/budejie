<template>
  <div class="alls">
      ...
      <div class="v-player" v-if="dataList.video">
        <video width="100%" :src="dataList.video.video[0]"></video>
      </div>
      <div class="v-gif" v-if="dataList.gif">
        <img :src="dataList.gif.images[0]">
      </div>
      <div class="v-img" v-if="dataList.image">
        <img width="100%" :src="dataList.image.big[0]">
      </div>
...
export default {
    ...
    updated () {
      this.plyr.setup(document.querySelectorAll('.v-player'), {
        enabled: true,
